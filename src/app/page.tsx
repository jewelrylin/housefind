            ...
            <div className="mb-6 rounded-2xl border border-amber-200 bg-amber-50 p-4 flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  <a href="https://www.sinyi.com.tw" target="_blank" rel="noopener noreferrer" className="text-xs px-2.5 py-1 rounded-lg bg-white text-amber-700 ring-1 ring-amber-300 hover:bg-amber-100 transition-colors">信義房屋</a>
                  <a href="https://www.yungching.com.tw" target="_blank" rel="noopener noreferrer" className="text-xs px-2.5 py-1 rounded-lg bg-white text-amber-700 ring-1 ring-amber-300 hover:bg-amber-100 transition-colors">永慶房屋</a>
                  <a href="https://www.rakuya.com.tw" target="_blank" rel="noopener noreferrer" className="text-xs px-2.5 py-1 rounded-lg bg-white text-amber-700 ring-1 ring-amber-300 hover:bg-amber-100 transition-colors">樂屋網</a>
                  <a href="https://www.housefun.com.tw" target="_blank" rel="noopener noreferrer" className="text-xs px-2.5 py-1 rounded-lg bg-white text-amber-700 ring-1 ring-amber-300 hover:bg-amber-100 transition-colors">好房網</a>
                  <a href="https://www.hbhousing.com.tw" target="_blank" rel="noopener noreferrer" className="text-xs px-2.5 py-1 rounded-lg bg-white text-amber-700 ring-1 ring-amber-300 hover:bg-amber-100 transition-colors">住商不動產</a>
                </div>
              </div>
            </div>
          )}
